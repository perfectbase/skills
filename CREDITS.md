...
This collection includes skills copied from, based on, or designed to work with skills created by other people and teams.
...
- [`html-plan`](skills/html-plan/) is based on [Builder.io's visual-plan skill](https://github.com/BuilderIO/skills/tree/main/skills/visual-plan).
- [`html-recap`](skills/html-recap/) is based on [Builder.io's visual-recap skill](https://github.com/BuilderIO/skills/tree/main/skills/visual-recap).
